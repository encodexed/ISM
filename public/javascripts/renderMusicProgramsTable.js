function renderMusicProgramsTable(tbl, musicPrograms) {
    ...
    for (let musicProgram of musicPrograms) {
        ...
        cellActions.innerHTML = `<a type="button" class="inline-block px-6 py-2.5 bg-yellow-500 text-white 
        font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-700 hover:shadow-lg
        focus:bg-yellow-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-800 active:shadow-lg
        transition duration-150 ease-in-out" href="/admin/music_program/${musicProgram._id}/enrol_students">Students</a>
        <a type="button" class="inline-block px-6 py-2.5 bg-purple-600 text-white 
